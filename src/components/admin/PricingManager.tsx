...
import { Plus, Trash2, Calendar, TrendingUp, Info, AlertCircle, Save, ExternalLink, Zap } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-6 relative z-10">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-[#6b5d4f] font-light max-w-xl mt-3 leading-relaxed text-left">
              ...
              Ahora puedes definir precios diferenciados para **fines de semana** (Vie, Sáb, Dom) dentro de cada temporada.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#e2d9cc] rounded-[40px] p-10 shadow-sm space-y-8 relative overflow-hidden">
        ...
        <form onSubmit={handleAddRule} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#6b7c4a] ml-1 flex">Precio Fin de Semana (Vie-Dom)</label>
              <div className="relative">
