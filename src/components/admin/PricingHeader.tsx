  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between gap-6 bg-white p-4 md:p-6 rounded-[24px] md:rounded-[32px] border border-sand-dark shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-8 w-full">
        <div className="p-4 bg-primary-navy/5 rounded-[20px] md:rounded-[24px] border border-primary-navy/10 w-full sm:w-auto">
          <p className="text-[10px] font-bold uppercase tracking-widest text-primary-navy/40 mb-1">Precio Base Actual</p>
          <div className="flex items-baseline gap-2">
            <span className="text-2xl md:text-3xl font-serif italic text-primary-navy">{formatCurrency(basePrice)}</span>
        ...
        <div className="space-y-2 flex-1 w-full">
          <p className="text-[10px] font-bold uppercase tracking-widest text-primary-navy/40 ml-1">Estado del Sistema</p>
          <div className="flex items-center gap-2 md:gap-4 flex-wrap">
            <div className="flex items-center gap-1.5 text-primary-navy bg-primary-navy/5 px-3 py-1.5 rounded-full border border-primary-navy/10">
            ...
            {nextHoliday && (
              <div className="flex items-center gap-1.5 text-primary-navy/80 bg-sand-light px-3 py-1.5 rounded-full border border-sand-dark">
