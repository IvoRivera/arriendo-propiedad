  ...
  return (
    <div className="bg-white border border-[#e2d9cc] rounded-[40px] p-10 shadow-sm space-y-8 relative overflow-hidden">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h3 className="text-xl font-serif-luxury italic text-[#2c2416] tracking-tight">Agregar Nueva Regla</h3>
          <p className="text-[9px] text-[#9a8a78] uppercase tracking-luxury font-bold text-left">Configuración de temporada especial</p>
        </div>
      </div>
      ...
      <form onSubmit={onAddRule} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-luxury text-[#9a8a78] ml-1 flex">Nombre de la Temporada</label>
            <input 
              required
              type="text" 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-luxury text-[#9a8a78] ml-1 flex">Fecha de Inicio</label>
            <input 
              required
              type="date" 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-luxury text-[#9a8a78] ml-1 flex">Fecha de Término</label>
            <input 
              required
              type="date" 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-luxury text-[#9a8a78] ml-1 flex">Precio Semanal (Lun-Jue)</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase tracking-luxury text-[#6b7c4a] ml-1 flex">Precio Fin de Semana (Vie-Sáb)</label>
            <div className="relative">
          ...
          <div className="space-y-3 lg:col-span-3">
            <label className="text-[10px] font-bold uppercase tracking-luxury text-[#9a8a78] ml-1 flex">Color en Calendario (Categoría)</label>
