// CoastalHero.tsx — Full-bleed hero, mobile-first
// data-stitch-id: hero-section (screen: 75756b60186b4c8da17437331f094caa)
...
export const CoastalHero: React.FC<CoastalHeroProps> = ({ className = "" }) => {
  return (
    <section className={`relative w-full min-h-[560px] h-[78vh] md:h-[82vh] overflow-hidden ${className}`}>
      {/* Background image */}
      <Image
        src={heroData.image}
