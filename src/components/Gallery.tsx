...
export default function Gallery() {
  ...
  const prevImage = (e?: React.MouseEvent) => {
    if (e) e.stopPropagation();
    if (selectedImage !== null && validImages.length > 0) {
      setSelectedImage((selectedImage - 1 + validImages.length) % validImages.length);
    }
  };
          ...
          {validImages[0] && (
            ...
            >
              <Image 
                ...
                alt={validImages[0].alt || "Imagen de la galería"} 
                fill 
          ...
          {validImages[1] && (
            ...
            >
              <Image 
                ...
                alt={validImages[1].alt || "Imagen de la galería"} 
                fill 
                sizes="(max-width: 768px) 100vw, 50vw"
                className="object-cover transition-transform duration-700 group-hover:scale-105" 
              />
          ...
          {validImages[2] && (
            ...
            >
              <Image 
                ...
                alt={validImages[2].alt || "Imagen de la galería"} 
                fill 
                sizes="(max-width: 768px) 100vw, 50vw"
                className="object-cover transition-transform duration-700 group-hover:scale-105" 
              />
      ...
      <AnimatePresence>
        {selectedImage !== null && validImages[selectedImage] && (
          ...
          >
            ...
            >
              {validImages[selectedImage]?.src && (
                <Image
                  src={validImages[selectedImage].src}
                  alt={validImages[selectedImage].alt || "Vista ampliada"}
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
